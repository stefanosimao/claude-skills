...
|---|---|---|---|---|
| ask-tete | 1.0.1 | 🧪 draft-built | manual | concierge over full catalog (Matt flows + mine); built 2026-07-28. 1.0.1: vendor-availability precondition added to Matt recommendations (FIX-3) |
| skill-forge | 1.1.1 | 🧪 draft-built | manual | skill-creator loop + house rules + writing-great-skills principles; supersedes stock skill-creator (block it). 1.1: invocation mode now asked with recommendation, drafting gated on open blocking questions (FIX-1, test report v1) · 1.1.1: surface-capability rule added to `references/conventions.md` invocation economics — claude.ai skills can't persist files, so accumulating state routes to a project |
