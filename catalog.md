...
|---|---|---|---|---|
| skill-forge | — | 📋 | manual | customized skill-creator; absorbs repo-skills guidance; supersedes stock skill-creator |
| project-setup | — | 📋 | auto(narrow) | encodes Skill-vs-Project framework; first test = good-father |

## Thinking & learning (Phase 3, book-distilled)

| Skill | Ver | Status | Invocation | Library folders |
|---|---|---|---|---|
| reasoning-toolkit | — | 📋 | auto(narrow) | reasoning-mental-models + decision-making + problem-solving |
| argument-analysis | — | 📋 | auto | critical-thinking-logic |
| negotiation-persuasion | — | 📋 | auto | negotiation-persuasion |
| society-lenses | — | 📋 | manual | economics + politics-geopolitics |
| study | — | 📋 | manual | meta-learning (reads all folders); coexists with /teach verbatim |
...
Status: 📋 pending vendor commit · Scope: **repo-scoped / manual only** (never account-wide) · Updates only via deliberate re-audit + pin bump.
...
| Skill | Ver | Status | Invocation | Notes |
|---|---|---|---|---|
| software-engineering | — | 📋 | auto(narrow) + callable | all-around SWE consultant; CS canon via Drive |
| extra-code-review | — | 📋 | manual | 4 axes: security/defects/performance/tests (per gap analysis) |
| ask-tete | — | 📋 | manual | catalog concierge + discovery layer for manual skills |

## Personal

| Skill | Ver | Status | Invocation | Enabled |
|---|---|---|---|---|
| settimana-enigmistica | — | 📋 | manual | claude.ai only |
| swiss-voting | — | 📋 | manual | claude.ai only; live-web hybrid, no stored data |
