...
| skill-forge | 1.1 | 🧪 draft-built | manual | skill-creator loop + house rules + writing-great-skills principles; supersedes stock skill-creator (block it). 1.1: invocation mode now asked with recommendation, drafting gated on open blocking questions (FIX-1, test report v1) |
